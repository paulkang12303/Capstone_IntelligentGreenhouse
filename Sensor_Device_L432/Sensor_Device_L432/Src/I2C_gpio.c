...
{
	I2C_BUS_2_SDA_1();us_delay(5);
	I2C_BUS_2_SCL_1();us_delay(5);
	if(I2C_BUS_2_SDA_READ()==0)	return 0;
	I2C_BUS_2_SDA_0();us_delay(5);
	if(I2C_BUS_2_SDA_READ()!=0) return 0;
	I2C_BUS_2_SCL_0();us_delay(5);
	return 1;
}
/*I2C STOP Signal (confirmed)*/
...
{
	if(I2C_BUS_2_Start()==0)
	{
		I2C_BUS_2_Stop();return 0;
	}
	I2C_BUS_2_SendByte(SlaveAddress);
	if(!I2C_BUS_2_WaitAck())
	{
		I2C_BUS_2_Stop();return 0;
	}
	I2C_BUS_2_SendByte(REGAddress);
	if(!I2C_BUS_2_WaitAck())
	{
		I2C_BUS_2_Stop();return 0;
	}
	I2C_BUS_2_SendByte(TxByte);
	if(!I2C_BUS_2_WaitAck())
	{
		I2C_BUS_2_Stop();return 0;
	}
...
uint8_t I2C_BUS_2_ReadDevice_Post(uint8_t SlaveAddress, uint8_t *RxByte, uint8_t length)
{
	...
	I2C_BUS_2_SendByte(SlaveAddress + 1);
	if(!I2C_BUS_2_WaitAck())
	{
		I2C_BUS_2_Stop();return 0;
	}
...
{
	I2C_BUS_3_SDA_1();us_delay(5);
	I2C_BUS_3_SCL_1();us_delay(5);
	if(I2C_BUS_3_SDA_READ()==0)	return 0;
	I2C_BUS_3_SDA_0();us_delay(5);
	if(I2C_BUS_3_SDA_READ()!=0) return 0;
	I2C_BUS_3_SCL_0();us_delay(5);
	return 1;
}
/*I2C STOP Signal (confirmed)*/
...
{
	if(I2C_BUS_3_Start()==0)
	{
		I2C_BUS_3_Stop();return 0;
	}
	I2C_BUS_3_SendByte(SlaveAddress);
	if(!I2C_BUS_3_WaitAck())
	{
		I2C_BUS_3_Stop();return 0;
	}
	I2C_BUS_3_SendByte(REGAddress);
	if(!I2C_BUS_3_WaitAck())
	{
		I2C_BUS_3_Stop();return 0;
	}
	I2C_BUS_3_SendByte(TxByte);
	if(!I2C_BUS_3_WaitAck())
	{
		I2C_BUS_3_Stop();return 0;
	}
...
uint8_t I2C_BUS_3_ReadDevice_Post(uint8_t SlaveAddress, uint8_t *RxByte, uint8_t length)
{
	...
	I2C_BUS_3_SendByte(SlaveAddress + 1);
	if(!I2C_BUS_3_WaitAck())
	{
		I2C_BUS_3_Stop();return 0;
	}
