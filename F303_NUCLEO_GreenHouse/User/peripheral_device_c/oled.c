...
{
	I2C_BUS_1_WriteDevide_SingleByte(0x78,0x00,OLED_Command);
}

void WriteDat(unsigned char OLED_Command)
{
	I2C_BUS_1_WriteDevide_SingleByte(0x78,0x40,OLED_Command);
}
...
void OLED_Init(void)
{
	...
	WriteCmd(0xff); //--set illumination 0x00~0xff
...
{
	OLED_CLS();
	OLED_ShowStr(0,1,"Greenhouse",2);
	OLED_ShowStr(0,4,"Author: Group7",1);
	OLED_ShowStr(0,5,"Mentor: Allan Smith",1);
}
